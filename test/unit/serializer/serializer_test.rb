...
class SerializerTest < MiniTest::Unit::TestCase
  ...
  def test_serializer_include
    ...
    assert_hash_equals({
                 ...
                 }, JSONAPI::ResourceSerializer.new.serialize_to_hash(PostResource.new(@post), include: [:author]))
  end
    ...
    assert_hash_equals(
        {
         ...
         }, JSONAPI::ResourceSerializer.new.serialize_to_hash(PostResource.new(@post), include: [:comments,'comments.tags']))
  end
    ...
    assert_hash_equals(
        {
         ...
         }, JSONAPI::ResourceSerializer.new.serialize_to_hash(PostResource.new(@post), include: ['comments.tags']))
  end
    ...
    assert_hash_equals(
        {
         ...
         }, JSONAPI::ResourceSerializer.new.serialize_to_hash(PostResource.new(@post), include: ['author.comments']))
  end
    ...
    assert_hash_equals(
        {
         ...
         }, JSONAPI::ResourceSerializer.new.serialize_to_hash(PersonResource.new(@fred), include: ['comments']))
  end
    ...
    assert_hash_equals(
        {
         ...
         }, JSONAPI::ResourceSerializer.new.serialize_to_hash(posts, include: ['comments','comments.tags']))
  end
  ...
  def test_serializer_array_of_resources_limited_fields
    ...
    assert_hash_equals(
        ...
        }, JSONAPI::ResourceSerializer.new.serialize_to_hash(posts,
  ...
  def test_serializer_camelized_with_value_formatters
    assert_hash_equals({
                       ...
                       }, JSONAPI::ResourceSerializer.new.serialize_to_hash(ExpenseEntryResource.new(@expense_entry),
